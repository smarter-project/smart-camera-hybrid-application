...
running on the Cortex-M4 via a named channel and address that need to match that specified in the Cortex-M4 firmware (see https://git.research.arm.com/attk/hybrid/smart-camera-hybrid-application/-/tree/main/rpmsg_cortexm_console_rtos) 


Building
========

This code can be compiled on the EVK board:

 gcc -o cortexm_console cortexm_console.c

or cross-compiled with a suitable compiler and then copied to the EVK board.
